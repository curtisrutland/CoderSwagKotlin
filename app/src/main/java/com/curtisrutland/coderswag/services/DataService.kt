...
object DataService {
    ...
    val hoodies = listOf(
            ...
            Product("Devslopes Hoodie Red", "$38", "hoodie2"),
            Product("Devslopes Hoodie Brown", "$28", "hoodie3"),
    ...
    val shirts = listOf(
            ...
            Product("Kickflip Studios Black", "$22", "shirt5"),
            Product("Devslopes Shirt Black", "$18", "shirt1"),
            Product("Devslopes Badge Light Gray", "$20", "shirt2"),
            Product("Devslopes Logo Shirt Red", "$22", "shirt3"),
            Product("Devslopes Hustle", "$22", "shirt4"),
    ...
    val ditigalGoods = listOf<Product>()
